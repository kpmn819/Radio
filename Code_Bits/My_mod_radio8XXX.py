...
# Version 6: start adding code to run graphics
# Version 7: move graphics initialization here
# Version 8: moved tuner calls out of the encoder code
# and into the main loop also removed sleep in main loop
#
import sys, pygame
...
eye_list = [eye0,eye0,eye1,eye1,eye2,eye2,eye3,eye3,
            eye4,eye4,eye5,eye5,eye6,eye6,eye6,eye6]
...
#BackGround = testing.Background(radio_img, [0,0])
#testing.display.blit(BackGround.image, BackGround.rect)
...
def get_blit(angle):
    ...
    testing.blit_em(radio,needle,mask,eye_now,angle)
...
def rotation_decode(Enc_A):
    ...
    if (Switch_A == 1) and (Switch_B == 0) : # A then B ->
        enc_val -= 1
        # encoder has turned get a new value for the needle angle
    ...
    try:
        ...
        while 1:
            ...
            if enc_val != enc_prev:
                ...
                print('ANGLE VALUE= ',angle, 'PREV / NEXT ',enc_prev,'/',enc_val)
                tuner(enc_val, angle)
                #enc_prev = enc_val
