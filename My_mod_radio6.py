...
eye_list = ['Eyeball0.png','Eyeball0.png','Eyeball0.png','Eyeball1.png','Eyeball1.png',
            'Eyeball2.png','Eyeball2.png','Eyeball3.png','Eyeball3.png','Eyeball4.png',
            'Eyeball4.png','Eyeball5.png','Eyeball5.png','Eyeball6.png','Eyeball6.png',
            'Eyeball6.png']
shuffle = False
...
def rotation_decode(Enc_A):
    ...
    if (Switch_A == 1) and (Switch_B == 0) : # A then B ->
        ...
        print ("direction <- ", enc_val, ' Needle angle= ',angle)
